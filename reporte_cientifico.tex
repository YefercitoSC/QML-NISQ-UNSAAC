...
El análisis descriptivo de los datos experimentales arroja las siguientes conclusiones:
\begin{itemize}
...
\bibitem{12} H. T. G. Figueroa, J. J. R. Ccoyto, R. H. Huallparimachi, ``Código Fuente y Suite de Simulación QML-NISQ-UNSAAC,'' Repositorio de GitHub, Cusco, 2026. Disponible en: \url{https://github.com/YefercitoSC/QML-NISQ-UNSAAC}.
\end{thebibliography}
